...
namespace Physix2D
{
	...
	{
		Ref<Rigidbody2D> body = CreateRef<Rigidbody2D>(spec);
	...
	void PhysicsWorld2D::BroadPhase()
	{
		...
		{
			Ref<Rigidbody2D> body1 = m_Bodies[i];
			...
			{
				Ref<Rigidbody2D> body2 = m_Bodies[j];
				...
				m_ContactPairs.emplace_back(i, j);
			}
		}
	}
	...
	void PhysicsWorld2D::NarrowPhase()
	{
		...
		{
			Ref<Rigidbody2D> body1 = m_Bodies[pair.BodyIndex1];
			Ref<Rigidbody2D> body2 = m_Bodies[pair.BodyIndex2];
	...
	bool PhysicsWorld2D::Collide(const Ref<Rigidbody2D>& body1, const Ref<Rigidbody2D>& body2, Collisions::ContactParams& contactParams)
	{
		m_ContactParams = {};
		...
		{
			Ref<BoxCollider> box1Collider = body1->GetShape<BoxCollider>();
			Vec2 box1Center = body1->m_Position + body1->m_Collider->Offset;

			if (shape2 == ShapeType::Circle)
			{
				Ref<CircleCollider> circleCollider = body2->GetShape<CircleCollider>();
			...
			{
				Ref<BoxCollider> box2Collider = body2->GetShape<BoxCollider>();
		...
		{
			Ref<CircleCollider> circle1Collider = body1->GetShape<CircleCollider>();
			Vec2 circle1Center = body1->m_Position + body1->m_Collider->Offset;

			if (shape2 == ShapeType::Circle)
			{
				Ref<CircleCollider> circle2Collider = body2->GetShape<CircleCollider>();
	...
	void PhysicsWorld2D::ResolveCollision(const Ref<Rigidbody2D>& body1, const Ref<Rigidbody2D>& body2, Collisions::ContactParams& contactParams)
	{
